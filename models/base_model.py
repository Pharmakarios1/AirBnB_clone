...
In this instance BaseModel class id defined
the will be called from the init function and other functions
"""
...
class BaseModel:
    """
        This is is the BaseModel of the project.
        which other class and instances will read from
        """
